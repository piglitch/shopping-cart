...
const Jeweleries = ({wishList, setWishList, cart, setCart}) => {
  ...
  useEffect(() => {
    if (!loading) {      
      setCategoryData(data.filter(item => item.category === 'jewelery'))
 ...
 // Reset to default
  ...
  return (
    <div>
      <h1 className='text-6xl font-extrabold text-black w-full p-2 bg-gradient-to-r from-yellow-300 to-white'>Jewelery</h1>
